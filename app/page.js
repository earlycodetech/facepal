    ...
    <>
      <div className="h-screen w-full flex flex-col justify-around bg">
        ...
        <div className="w-full flex flex-col sm:flex-row justify-center items-center gap-4 px-8 sm:px-10 lg:px-24">
          <div className="w-full sm:min-h-[480px] bg-igit ndigo-300/20 py-6 sm:py-10 px-[40px] rounded-lg">
            ...
            <Text size={20}>
              <span className="font-mono">Rthge</span>
              <p >This is a paragraph</p>
            </Text>
            {/* <Text colour="orange" size={29} />
            <Text colour="brown" size={19} /> */}
          </div>
